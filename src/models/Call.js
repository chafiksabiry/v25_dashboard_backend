...
const callSchema = new mongoose.Schema({
  ...
  ai_call_score: {
    ...
    "PAS INTÉRESSÉS":       { score: { type: Number, min: 0, max: 100 }, feedback: { type: String }, passed: { type: Boolean, default: false } },
    "PAS AU COURANT":       { score: { type: Number, min: 0, max: 100 }, feedback: { type: String }, passed: { type: Boolean, default: false } },
    "DÉJÀ ÉQUIPÉS":         { score: { type: Number, min: 0, max: 100 }, feedback: { type: String }, passed: { type: Boolean, default: false } },
    "RDV":                  { score: { type: Number, min: 0, max: 100 }, feedback: { type: String }, passed: { type: Boolean, default: false } },
    "A plus tard":          { score: { type: Number, min: 0, max: 100 }, feedback: { type: String }, passed: { type: Boolean, default: false } },
