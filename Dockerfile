...
ENV ZOHO_REDIRECT_URI=https://prod-api-dashboard.harx.ai/api/zoho/auth/callback
...
ENV REACT_APP_URL=https://prod-dashboard.harx.ai
ENV BACKEND_URL=https://prod-api-dashboard.harx.ai
